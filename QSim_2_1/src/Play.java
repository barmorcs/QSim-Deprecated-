    ...
    public static void main(String[] args) throws IOException {
        {
            ...
            String inTeam1 = "src/teams/Ashwinders.txt";
            String inTeam2 = "src/teams/Kappas.txt";
		...
		Random rnd = new Random(Seed);
                ...
                int chance = randomno.nextInt(25);
                ...
                int chance1 = randomno.nextInt(7);
                int foulChance = randomno.nextInt(7);
...
System.out.println();
    ...
    /**
     * IS SOMEONE KNOCKED OUT
     *
     * @return knocked out players
     */
    public static String knockedOutStat() {
        ...
        while (it.hasNext()) {
            ...
            if (Players.get(pair.getKey()).knockedOut) {
                System.out.println(Players.get(pair.getKey()).name + " was knocked out");
            }
    ...
    /**
     * gets a player on the opposite team with the same position
     *
     * @param pID
     * @param position
     * @return
     ...
     *
     * @param team
     * @return random player on opposite team
     */
    ...
    public static boolean playInterrupt(Chaser target) {
        int Seed = (int)System.nanoTime(); 
        Random rnd = new Random(Seed);
        int chance = rnd.nextInt(19);
        if (chance == 1 || chance == 7 || chance == 4)//chaser can be interrupted by a beater
        {
