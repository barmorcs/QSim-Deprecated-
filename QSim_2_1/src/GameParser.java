                    ...
                    for (int k = 0; k < 1; k++) {//open table
                        ...
                        for (int i = 0; i < 60; i++) {
                            if (s.hasNext()) {
                                ...
                                if (line.contains("!") || line.contains("points") || line.contains("intercepted") || line.contains("failed to block") || line.contains("Snitch") || line.contains("Reverse") || line.contains(":") || line.contains("attempted to shoot a goal") || line.contains("attempted a goal") || line.contains("flew") || line.contains("called a foul") || line.contains("blocked") || line.contains("knocked") || line.contains("remaining") || line.contains("hit") || line.contains("scored") || line.contains("aimed") || line.contains("dodged") || line.contains("penalty")) {
                                    if (line.contains("HP") || line.contains("head to")) {
