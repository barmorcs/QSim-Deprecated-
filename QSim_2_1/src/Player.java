...
public class Player {
    ...
    public boolean playsDirty, knockedOut, pro, isLead;
    ...
    //Overloaded for isLead
        public void setStats(int re, int sp, int str, int si, int a, String d, boolean fouls, boolean isLead) {
        reflex = re;
        sight = si;
        aim = a;
        strength = str;
