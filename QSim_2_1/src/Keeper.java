...
public class Keeper extends Player {
	...
	Random rnd = new Random(Seed);
        ...
        if (total1 > p3) {
            ...
            return passTo.catchQuaffle(total1 - p3);

        } else if (total1 > p2) {
            System.out.print(this.name + " threw a Reverse Pass");
            return passTo.catchQuaffle(total1 - p2);
        }

        if (total1 > base) {
            System.out.print(this.name + " passed the Quaffle");
            return passTo.catchQuaffle(total1 - base);
            
        } if (total1 > p1) {
            System.out.print(this.name + " threw a wide pass");
            return passTo.catchQuaffle(total1 - base);
